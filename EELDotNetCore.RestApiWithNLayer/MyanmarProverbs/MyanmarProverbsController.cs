...
namespace EELDotNetCore.RestApiWithNLayer.MyanmarProverbs;
...
public class MyanmarProverbsController : ControllerBase
{
    private async Task<Tbl_Mmproverbs> GetDataFromApi()
    {
        ...
        //var respond = await client.GetAsync("https://raw.githubusercontent.com/sannlynnhtun-coding/Myanmar-Proverbs/main/MyanmarProverbs.json");
        //if (!respond.IsSuccessStatusCode) return null;

        //    string jsonStr = await respond.Content.ReadAsStringAsync();
